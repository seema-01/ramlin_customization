...
class Rider_model extends CI_Model
{
    ...
    function get_riders_list($cash_collection = false, $rider_requests = false)
    {
        ...
        if (isset($_GET['status']) && $_GET['status'] !== NULL && $_GET['status'] !== '') {
            $count_res->where("active", intval($_GET['status']));
        }
        if (!empty($_GET['commission_method'])) {
            $count_res->where("commission_method", $_GET['commission_method']);
        }
        ...
        if (isset($_GET['status']) && $_GET['status'] !== NULL && $_GET['status'] !== '') {
            $search_res->where("active", intval($_GET['status']));
        }
        if (!empty($_GET['commission_method'])) {
            $search_res->where("commission_method", $_GET['commission_method']);
        }
