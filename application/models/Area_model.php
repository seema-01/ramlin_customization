...
class Area_model extends CI_Model
{
    ...
    function add_city($data)
    {
        ...
        if (isset($data['boundary_points']) && !empty($data['boundary_points']) && $data['boundary_points'] != "") {
            ...
            $city_data = [
                ...
                'min_order_amount_for_free_delivery' => $data['min_order_amount_for_free_delivery'],
    ...
    function get_list()
    {
        ...
        $tax_search_res = $search_res->order_by($sort, $order)->limit($limit, $offset)->get('cities')->result_array();
        ...
        foreach ($tax_search_res as $row) {
            ...
            $tempRow['min_order_amount_for_free_delivery'] = $row['min_order_amount_for_free_delivery'];
