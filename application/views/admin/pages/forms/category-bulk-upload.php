                        ...
                        <form class="form-horizontal" action="<?= base_url('admin/category/process_bulk_upload'); ?>" method="POST" id="bulk_upload_form">
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="form-group category_bulk">
                                        ...
                                        <a href="<?= base_url('uploads/category-bulk-update-sample-erestro.csv') ?>" class="btn btn-secondary ml-2" download="category-bulk-update-sample-erestro.csv">Bulk update sample file <i class="fas fa-download"></i></a>
                                    </div>
