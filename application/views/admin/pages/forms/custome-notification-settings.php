    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                    ...
                    <div class="card card-info">
                        ...
                        <form class="form-horizontal form-submit-event" action="<?= base_url('admin/custom_notification/add_notification'); ?>" method="POST" id="add_product_form" enctype="multipart/form-data">
                            ...
                            <div class=" card-body">
                                ...
                                $type = ['place_order', 'customer_order_pending', 'customer_order_confirm', 'customer_order_preparing', 'customer_order_ready_for_pickup', 'customer_order_out_for_delivery', 'customer_order_cancel', 'customer_order_delivered', 'rider_assign_order', 'rider_pending_order'];
                                ?>
                                ...
                                <div class="form-group row customer_order_pending <?= (isset($fetched_data[0]['id'])  && $fetched_data[0]['type'] == 'customer_order_pending') ? '' : 'd-none' ?>">
                                    <label for="message" class="col-sm-2 col-form-label"></label></label>
                                    <?php
                                    $hashtag = ['< order_item_id >', '< application_name >'];
                                    foreach ($hashtag as $row) { ?>
                                        <div class="col">
                                            <div class="hashtag"><?= $row ?></div>
                                        </div>
                                ...
                                <div class="form-group row customer_order_confirm <?= (isset($fetched_data[0]['id'])  && $fetched_data[0]['type'] == 'customer_order_confirm') ? '' : 'd-none' ?>">
                                    <label for="message" class="col-sm-2 col-form-label"></label></label>
                                    <?php
                                    $hashtag = ['< order_item_id >', '< application_name >'];
                                    foreach ($hashtag as $row) { ?>
                                ...
                                <div class="form-group row customer_order_preparing <?= (isset($fetched_data[0]['id'])  && $fetched_data[0]['type'] == 'customer_order_preparing') ? '' : 'd-none' ?>">
                                    <label for="message" class="col-sm-2 col-form-label"></label></label>
                                    <?php
                                    $hashtag = ['< order_item_id >', '< application_name >'];
                                    foreach ($hashtag as $row) { ?>
                                ...
                                <div class="form-group row customer_order_out_for_delivery <?= (isset($fetched_data[0]['id'])  && $fetched_data[0]['type'] == 'customer_order_out_for_delivery') ? '' : 'd-none' ?>">
                                    <label for="message" class="col-sm-2 col-form-label"></label></label>
                                    <?php
                                    $hashtag = ['< order_item_id >', '< application_name >'];
                                    foreach ($hashtag as $row) { ?>
                                ...
                                <div class="form-group row customer_order_ready_for_pickup <?= (isset($fetched_data[0]['id'])  && $fetched_data[0]['type'] == 'customer_order_ready_for_pickup') ? '' : 'd-none' ?>">
                                    <label for="message" class="col-sm-2 col-form-label"></label></label>
                                    <?php
                                    $hashtag = ['< order_item_id >', '< application_name >'];
                                    foreach ($hashtag as $row) { ?>
                                ...
                                <div class="form-group row customer_order_cancel <?= (isset($fetched_data[0]['id'])  && $fetched_data[0]['type'] == 'customer_order_cancel') ? '' : 'd-none' ?>">
                                    <label for="message" class="col-sm-2 col-form-label"></label></label>
                                    <?php
                                    $hashtag = ['< order_item_id >', '< application_name >'];
                                    foreach ($hashtag as $row) { ?>
                                ...
                                <div class="form-group row rider_assign_order <?= (isset($fetched_data[0]['id'])  && $fetched_data[0]['type'] == 'rider_assign_order') ? '' : 'd-none' ?>">
                                    <label for="message" class="col-sm-2 col-form-label"></label></label>
                                    <?php
                                    $hashtag = ['< rider_name >', '< order_id >', '< application_name >'];
                                    foreach ($hashtag as $row) { ?>
                                        <div class="col">
                                            <div class="hashtag"><?= $row ?></div>
                                        </div>
                                ...
                                <div class="form-group row rider_pending_order <?= (isset($fetched_data[0]['id'])  && $fetched_data[0]['type'] == 'rider_pending_order') ? '' : 'd-none' ?>">
                                    <label for="message" class="col-sm-2 col-form-label"></label></label>
                                    <?php
                                    $hashtag = ['< order_id >'];
                                    foreach ($hashtag as $row) { ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <button type="submit" class="btn btn-info" id="submit_btn"><?= (isset($fetched_data[0]['id'])) ? 'Update Custom message ' : 'Add Custom message ' ?></button>
                                </div>
                ...
                <div class="modal fade edit-modal-lg custome_notification_update" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
