                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card card-info">
                            <div class="card-body">
                                <?php
                                // print_r(get_settings('system_settings', true)); 
                                ?>
                    ...
                    <div class="col-md-6">
                        <div class="card card-info">
                            <div class="card-body">
                                ...
                                <div class="form-group col-md-6">
                                    <label for="google_map_app_api_key"> Googel Map KEY (For Application) <span class='text-danger text-xs'>*</span></label>
                                    <input type="text" class="form-control" name="google_map_app_api_key" value="<?= (isset($settings['google_map_app_api_key']) && defined('ALLOW_MODIFICATION') && ALLOW_MODIFICATION == 0)
                                                                                                                        ? str_repeat("X", strlen($settings['google_map_app_api_key']) - 3) . substr($settings['google_map_app_api_key'], -3)
                                                                                                                        : (isset($settings['google_map_app_api_key']) ? $settings['google_map_app_api_key'] : '') ?>" placeholder="Enter your Google Map App API KEY" />
                                </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="number" class="form-control" name="minimum_cart_amt" oninput="validateNumberInput(this)" value="<?= (isset($settings['minimum_cart_amt'])) ? $settings['minimum_cart_amt'] : '' ?>" placeholder='Minimum Cart Amount' min='0' />
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="max_items_cart"> Maximum Items Allowed In Cart <span class='text-danger text-xs'>*</span></label>
                                        <input type="number" class="form-control" name="max_items_cart" oninput="validateNumberInput(this)" value="<?= (isset($settings['max_items_cart'])) ? $settings['max_items_cart'] : '' ?>" placeholder='Maximum Items Allowed In Cart' min='0' />
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        <label for="max_items_cart"> Low stock limit <small>(Product will be considered as low stock)</small> </label>
                                        <input type="number" class="form-control" name="low_stock_limit" oninput="validateNumberInput(this)" value="<?= (isset($settings['low_stock_limit'])) ? $settings['low_stock_limit'] : '5' ?>" placeholder='Product low stock limit' min='1' />
                                    </div>
                                </div>
                    ...
                    <div class="col-md-12">
                        <div class="card card-info">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-3">
                                        <label for="is_app_maintenance_mode_on"> Customer App Maintenance Mode </label>
                                        <div class="card-body">
