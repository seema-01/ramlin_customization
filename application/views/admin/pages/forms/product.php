                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="card card-info">
                                                <form class="form-horizontal form-submit-event"
                                                    action="<?= base_url('admin/tag/add_tags_from_product'); ?>"
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group ">
                                            ...
                                            <div class="mb-2">
                                                <a href="javascript:void(0);"
                                                    class="text-primary openTagModal"
                                                    style="font-size: 13px; text-decoration: none;">
                                                    <i class="fas fa-external-link-alt"></i> Add Tags
                                                </a>
                                            </div>
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="col-sm-12">
                                                <input type="number" class="form-control" oninput="validateNumberInput(this)" min="0" id="calories" placeholder="Enter calories in cal unit" name="calories" value="<?= @$product_details[0]['calories'] ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="total_allowed_quantity" class="col-sm-4 col-form-label">Total Allowed Quantity</label>
                                            <div class="col-sm-12">
                                                <input type="number" class="form-control" oninput="validateNumberInput(this)" name="total_allowed_quantity" value="<?= (isset($product_details[0]['total_allowed_quantity'])) ? $product_details[0]['total_allowed_quantity'] : ''; ?>" placeholder='Total Allowed Quantity' min="0">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="minimum_order_quantity" class="col-sm-4 col-form-label">Minimum Order Quantity</label>
                                            <div class="col-sm-12">
                                                <input type="number" class="form-control" oninput="validateNumberInput(this)" name="minimum_order_quantity" value="<?= (isset($product_details[0]['minimum_order_quantity'])) ? $product_details[0]['minimum_order_quantity'] : ''; ?>" placeholder='Minimum Order Quantity'>
                                            </div>
                                        </div>
                                        <div class="form-group ">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="col-sm-12">
                                                    <input type="number" class="form-control" oninput="validateNumberInput(this)" id="add_on_price" placeholder="Add ON Price" name="price" min="1">
                                                </div>
                                            </div>
                                            <div class="form-group ">
                                                <label for="add_on_calories" class="col-sm-3 col-form-label">Calories </label>
                                                <div class="col-sm-12">
                                                    <input type="number" class="form-control" oninput="validateNumberInput(this)" id="add_on_calories" placeholder="Add On Calories" name="add_on_calories" min="1">
                                                </div>
                                            </div>
                                            <!-- <div class="form-group ">
