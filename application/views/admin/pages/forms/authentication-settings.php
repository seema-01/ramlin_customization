                                ...
                                <div class="d-flex">
                                    <div class="firebase_config d-none">
                                        <a href="<?= base_url('admin/web-setting/firebase') ?>">
                                            <p class="firebase_configgg">Please config firebase config here *</p>
                                        </a>
                                    </div>
                                    <div class="sms_gateway d-none">
                                        <a href="<?= base_url('admin/sms-gateway-settings') ?>">
                                            <p class="firebase_configgg">Please config SMS gateway config here * </p>
                                        </a>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <button type="reset" class="btn btn-warning">Reset</button>
                                    <button type="submit" class="btn btn-info update_authentication_mode" id="submit_btn">Update Authentication Settings</button>
                                </div>
