                        ...
                        <form class="form-horizontal form-submit-event" action="<?= base_url('admin/Payment_settings/update_payment_settings'); ?>" method="POST" id="payment_setting_form">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-8">
                                        <input type="text" class="form-control" readonly value="<?= base_url('app/v1/api/flutterwave_webhook') ?>" />
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        <label for="">Payment Mode <small>[ sandbox / live / UAT ]</small>
                                        </label>
                                    </div>
                                    <div class="form-group col-md-8">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        <label for="phonepe_client_id">Client ID <span class='text-danger text-sm'>*</span></label>
                                    </div>
                                    <div class="form-group col-md-8">
                                        <input type="text" class="form-control" name="phonepe_client_id" value="<?= isset($settings['phonepe_client_id']) && (defined('ALLOW_MODIFICATION') && ALLOW_MODIFICATION == 0) ? str_repeat("X", strlen($settings['phonepe_client_id']) - 3) . substr($settings['phonepe_client_id'], -3) : @$settings['phonepe_client_id'] ?>" placeholder="Client ID" />
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-4">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        <label for="phonepe_client_secret">Client Secret <span class='text-danger text-sm'>*</span></label>
                                    </div>
                                    <div class="form-group col-md-8">
                                        <input type="text" class="form-control" name="phonepe_client_secret" value="<?= isset($settings['phonepe_client_secret']) && (defined('ALLOW_MODIFICATION') && ALLOW_MODIFICATION == 0) ? str_repeat("X", strlen($settings['phonepe_client_secret']) - 3) . substr($settings['phonepe_client_secret'], -3) : @$settings['phonepe_client_secret'] ?>" placeholder="Client Secret" />
                                    </div>
                                </div>
                                <!-- phonepe end -->
