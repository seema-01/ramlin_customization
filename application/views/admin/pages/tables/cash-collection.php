                                ...
                                <form class="form-horizontal form-submit-event" action="<?= base_url('admin/riders/manage_cash_collection'); ?>" method="POST" enctype="multipart/form-data">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="number" name="amount" id="amount" class="form-control" onkeyup="validate_amount(this.value);" oninput="validateNumberInput(this)">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                ...
                <div class="col-md-12 main-content">
                    <div class="card content-area p-4">
                        ...
                        <div class="card-innr">
                            ...
                            <table class='table table-striped cash_collection_transaction' data-toggle="table" data-show-footer="true" data-url="<?= base_url('admin/riders/get_cash_collection') ?>" data-click-to-select="true" data-side-pagination="server" data-pagination="true" data-page-list="[5, 10, 20, 50, 100, 200]" data-search="true" data-show-columns="true" data-show-refresh="true" data-trim-on-search="false" data-sort-name="id" data-sort-order="desc" data-mobile-responsive="true" data-toolbar="" data-show-export="true" data-maintain-selected="true" data-export-types='["txt","excel"]' data-export-options='{
                                    "fileName": "delivery-boy-cash-collection-list","ignoreColumn": ["operate"]}' data-query-params="cash_collection_query_params">
                                <thead>
                                    <tr>
                                        <th data-field="id" data-sortable="true">Id</th>
                                        <th data-field="name" data-sortable="false">User Name</th>
