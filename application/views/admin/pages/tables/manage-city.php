                        ...
                        <form class="form-horizontal form-submit-event" action="<?= base_url('admin/area/add_city'); ?>"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" oninput="validateNumberInput(this)" name="time_to_travel" id="time_to_travel"
                                ...
                                <div class="form-group ">
                                    ...
                                    <input type="number" class="form-control" oninput="validateNumberInput(this)" name="max_deliverable_distance"
                                ...
                                <div class="form-group d-none" id="fixed_charge_input">
                                    <label for="fixed_charge">Fixed Delivery Charges <span
                                            class='text-danger text-sm'>*</span></label>
                                    <input type="number" class="form-control" oninput="validateNumberInput(this)" name="fixed_charge" id="fixed_charge"
                                ...
                                <div class="form-group d-none" id="per_km_charge_input">
                                    <label for="per_km_charge">Per KM Delivery Charges <span
                                            class='text-danger text-sm'>*</span> </label>
                                    <input type="number" class="form-control" oninput="validateNumberInput(this)" name="per_km_charge" id="per_km_charge"
                                ...
                                <div class="form-group col-sm-12 d-none" id="range_wise_charges_input">
                                    ...
                                    <?php for ($i = 1; $i < 16; $i++) { ?>
                                        <div class="form-group row">
                                            <div><?= $i . '. ' ?></div>
                                            <div class="col-sm-2">
                                                <input type="number" class="form-control" oninput="validateNumberInput(this)" name="from_range[]"
                                                    id="from_range<?= $i ?>" placeholder="From Range" min="0">
                                            </div>
                                            <div class="btn  btn-secondary">To</div>
                                            <div class="col-sm-2">
                                                <input type="number" class="form-control" oninput="validateNumberInput(this)" name="to_range[]"
                                                    id="to_range<?= $i ?>" placeholder="To Range" min="0">
                                            </div>
                                            <div class="col-sm-4">
                                                <input type="number" class="form-control" oninput="validateNumberInput(this)" name="price[]" id="price<?= $i ?>"
