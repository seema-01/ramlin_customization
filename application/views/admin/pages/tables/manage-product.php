                    ...
                    <div class="card content-area p-4">
                        ...
                        <div class="card-innr">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <label for="zipcode" class="col-form-label">Filter By Indicator</label>
                                    <select class='form-control' name='indicator' id="indicators_filter">
                                ...
                                <div class="col-md-3">
                                    <label for="zipcode" class="col-form-label">Filter By Product Type</label>
                            ...
                            "ignoreColumn": ["state"] 
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th data-field="rating" data-sortable="false">Rating</th>
                                        <th data-field="variations" data-sortable="false" data-visible='false'>Variations</th>
