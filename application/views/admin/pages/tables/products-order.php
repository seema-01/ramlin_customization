                                        ...
                                        <ul class="list-group bg-grey move order-container" id="sortable">
                                            ...
                                            ?>
                                                <li class="list-group-item d-flex bg-gray-light align-items-center h-25" id="product_id-<?= $row['id'] ?>">
                                                    ...
                                                    <div class="col-md-4 product-order"><span><?= stripslashes($row['name']) ?></span></div>
                                                    ...
                                                    <?php
                                                    $img_path = !empty($row['image']) && file_exists(FCPATH . $row['image'])
                                                        ? base_url() . $row['image']
                                                        : base_url() . NO_IMAGE   // your default image
                                                    ?>
                                                    <div class="col-md-4 product-order">
                                                        <img src="<?= $img_path ?>" class="w-25">
                                                    </div>
