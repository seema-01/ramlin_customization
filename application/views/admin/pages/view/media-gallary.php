        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12 mt-3 mb-3">
                    ...
                    <div id="dropzone" class="dropzone media_upload_files"></div>
                    <br>
                        ...
                        <div class="col-md-12 main-content">
                            <div class="card content-area p-4">
                                ...
                                <div class="card-innr">
                                        ...
                                        <!-- Bulk Delete Button -->
                                        <br><button id="delete_selected" class="btn btn-danger">Delete Selected</button>

                                        <table class='table-striped media-table' id='media-table' data-page-size="5" data-toggle="table"
                                            data-url="<?= base_url('admin/media/fetch') ?>" data-click-to-select="true"
                                            ...
                                            data-show-export="true" data-query-params="mediaUploadParams">
                                            <thead>
                                                <tr>
