        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent nav-flat" data-widget="treeview" role="menu" data-accordion="false">
               ...
               with font-awesome or any other icon font library -->
                ...
                <li class="nav-item">
                    <a href="<?= base_url('rider/orders/') ?>" class="nav-link <?= is_url_active('rider/orders') ? 'active' : '' ?>">
                ...
                <li class="nav-item">
                    <a href="<?= base_url('rider/fund-transfer/manage-cash') ?>" class="nav-link">
                        <i class="fas fa-money-bill-alt nav-icon text-success"></i>
                        <p> Cash Collection </p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="<?= base_url('rider/payment-request/withdrawal-requests') ?>" class="nav-link">
