            ...
            <div class="card content-area p-4">
                <div class="card-header border-0">
                    <div class="card-tools">
                        <a href="<?= base_url() . 'rider/payment-request/send-withdrawal-request' ?>" class="btn btn-block  btn-outline-info  btn-sm">Send Withdrawal Request</a>
                    </div>
                </div>
                <div class="card-innr">
                    <div class="form-group col-md-3">
                        <label>Filter By Status</label>
                        <select id="status_filter" name="status_filter" placeholder="Select withdrawal status" required="" class="form-control">
